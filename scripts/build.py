...
def sidebar(active):
    ...
    return f'''<aside class="sidebar" id="sidebar"><a class="brand" href="index.html"><span class="brand-mark">s<span>✳</span></span><span>Spark<span class="brand-sub">FIELDNOTES</span></span></a>
